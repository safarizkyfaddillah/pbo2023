...
import math
from Fungsi import luas_limas_segitiga,volume_limas_segitiga

def luas(panjang_alas, tinggi_segitiga, tinggi_limas):
    value = luas_limas_segitiga(panjang_alas, tinggi_segitiga, tinggi_limas)
    entry_luas.delete(0, tk.END)
    entry_luas.insert(tk.END, value)

def volume(panjang_alas, tinggi_segitiga, tinggi_limas):
    value = volume_limas_segitiga(panjang_alas, tinggi_segitiga, tinggi_limas)
