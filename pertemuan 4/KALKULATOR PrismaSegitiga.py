...
import math
from Fungsi import luas_segitiga,luas_permukaan_prisma, volume_prisma_segitiga

def luas(alas_segitiga, tinggi_segitiga):
    value = luas_segitiga(alas_segitiga, tinggi_segitiga)
    entry_luas_segitiga.delete(0, tk.END)
    entry_luas_segitiga.insert(tk.END, value)

def luas(alas_segitiga, tinggi_segitiga, tinggi_permukaan_prisma):
    value = luas_permukaan_prisma(alas_segitiga, tinggi_segitiga, alas_segitiga, tinggi_permukaan_prisma)
    entry_luas_permukaan_prisma.delete(0, tk.END)
    entry_luas_permukaan_prisma.insert(tk.END, value)

def volume(alas_segitiga, tinggi_segitiga, tinggi_permukaan_prisma):
    luas_segitiga = volume_prisma_segitiga(alas_segitiga, tinggi_segitiga, tinggi_permukaan_prisma)
    value = luas_segitiga * tinggi_permukaan_prisma
...
def hitung():
    ...
    tinggi_permukaan_prisma = float(entry_tinggi_permukaan_prisma.get())
    luas_segitiga(alas_segitiga, tinggi_segitiga)
    luas_permukaan_prisma(alas_segitiga, tinggi_segitiga, tinggi_permukaan_prisma)
    volume(alas_segitiga, tinggi_segitiga, tinggi_permukaan_prisma)
...
# Tinggi Permukaan Prisma
label_tinggi_permukaan_prisma = ttk.Label(frame, text="Tinggi Permukaan Prisma")
label_tinggi_permukaan_prisma.grid(column=0, row=2, sticky=tk.W, padx=10, pady=10)

entry_tinggi_permukaan_prisma = ttk.Entry(frame)
entry_tinggi_permukaan_prisma.grid(column=1, row=2, padx=10, pady=10)
