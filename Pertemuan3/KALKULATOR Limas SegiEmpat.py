...
def luas(panjang, lebar, tinggi_limas):
    value = luas_limas_segiempat(panjang, lebar, tinggi_limas)
    entry_luas.delete(0, tk.END)
    entry_luas.insert(tk.END, value)

def volume(panjang, lebar, tinggi):
    value = volume_limas_segiempat(panjang, lebar, tinggi)
...
def hitung():
    ...
    luas(panjang, lebar, tinggi_limas)
